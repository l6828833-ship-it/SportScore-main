...
const espnTeams = require('../services/espn/teams');
const scrapeTeams = require('../services/scrape/teams');

const livescoreTeams = require('../services/livescore/teams');
const scores365Teams = require('../services/scores365/teams');
...
const forSource = (apifootball) =>
  source.pick({
    ...
    espn: espnTeams,
    scrape: scrapeTeams,
    livescore: livescoreTeams,
    '365scores': scores365Teams,
  });

const teamsModel = forSource(require('../services/teams/teams'));
const teamsStats = forSource(require('../services/teams/statistics'));
const teamSeasons = forSource(require('../services/teams/seasons'));
